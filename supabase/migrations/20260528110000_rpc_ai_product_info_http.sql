...
BEGIN
  ...
  -- 5. Body request Gemini cu schema JSON structurata
  ...
  -- 7. Extrage textul JSON din raspuns
  BEGIN
  ...
  -- 9. Returneaza rezultat (acelasi format ca edge function)
  RETURN jsonb_build_object(
    'success',    true,
