    ...
    components: [
      {
        ...
        searchTerms: ["plăci tavan casetat 600x600 Armstrong modular"],
        quantityFormula: ctx => round2(ctx.S * 1.05),
        unit: "mp", isOptional: false, defaultSelected: true,
      },
      {
        role: "profil_principal", label: "Profil T24 principal 3600mm",
        searchTerms: ["profil T24 principal tavan suspendat 3600mm"],
        quantityFormula: ctx => round2(ctx.S / 1.2),
        unit: "ml", isOptional: false, defaultSelected: true,
      },
      {
        role: "profil_secundar", label: "Profil T24 secundar 600mm",
        searchTerms: ["profil T24 secundar 600mm tavan casetat"],
        quantityFormula: ctx => round2(ctx.S / 0.6),
        unit: "ml", isOptional: false, defaultSelected: true,
      },
      {
        role: "profil_perete", label: "Profil perete L tavan",
        searchTerms: ["profil perete L tavan suspendat"],
        quantityFormula: ctx => round2(ctx.perimeter),
        unit: "ml", isOptional: false, defaultSelected: true,
      },
      {
        role: "nonius", label: "Nonius reglabil tavan",
        searchTerms: ["nonius reglabil tavan suspendat"],
        quantityFormula: ctx => Math.ceil(ctx.S / 1.44),
        unit: "buc", isOptional: false, defaultSelected: true,
      },
      {
        role: "tija_diblu", label: "Tijă filetată M6 + diblu",
        searchTerms: ["tijă filetată M6 diblu metal tavan"],
        quantityFormula: ctx => Math.ceil(ctx.S / 1.44),
        unit: "buc", isOptional: false, defaultSelected: true,
      },
    ],
