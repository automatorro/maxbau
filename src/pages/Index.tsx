...
const salesFeatures = [
  ...
  {
    title: "Ofertă nouă",
    subtitle: "Ofertare unificată & AI",
    description:
      "Creați oferte complete (clasic sau din cerere text cu AI) cu variante multiple de materiale, calcul automat de consum/ambalare și export Excel comparativ.",
    url: "/quote/new",
    icon: FilePlus,
    badge: "AI & VARIANTE",
    badgeVariant: "default" as const,
